...
\begin{position}
  Developing automatic instrumentation and reporting of one of the important vital parameters, motivated by giving continuous feedback to the attending physician about the patients condition.  
  ...
  Embedded development, instumentation, Linux, BOOST, and software development.
\end{position}
...
\begin{position}
  Responsible for signal acquisition/ processing for the newly developed PS3 pipe scanner and planning of next generation pipescanner (PS4). Communication with DataRespons at Lysaker, R\&D department in Moskow, and collaborating Norwegian universities and NDT professinals.
\end{position}
