...
PhD Candidate, Reinforcement Learning for Ship Autonomy, UiT, 2017 - 2022

Visiting Scholar of \emph{Richard Sutton}, RLAI lab/AMII, Edmonton, 2020

    {\small Project Summary:} 
    \emph{
    Reinforcement Learning (RL) in AI is capable of interaction learning and autonomous algorithms,
    however, 
    today's methods are limited for large problems or real-world applications.
    My work combines ground-breaking research from the Moser lab with Richard Sutton's ideas on modern RL.
...
\begin{position}
    ...
    Combining inspiration from neural representation of space, results from the Moser lab resulting in the 2014 Nobel price, with RL in AI, %, as pioneered by Richard Sutton, 
        my neoRL approach demonstrates real-time autonomous navigation in 2D spaces.
        %this project has demonstrated how genuine autonomy is possible for maritime navigation.
