...
%% TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO 
    ...
    however, today's methods word only for limited state spaces -- exluding real-world interraction learning.
    %however, today's methods are limited to small challenges -- excluding physical interraction learning. % does not work well for physical interraction learning. %real-world applications.
	This project combines established theories from learning psychology with Richard Sutton's insights into modern RL.
	%The resulting framework has been demonstrated for simulated challenges, ready to be implemented on hardware.
	Algorithms are ready to be implemented on hardware.
	%%
	%The resulting algorithms gave impressive simultaed results, and are ready to be implemented on real hardware.
...
\dates{2023 - 2024}
\begin{position}
	Project development and acquiring soft funding for Hyke -- leading the efforts
...
\begin{position}
	...
	The position involves {\emph{UKA05, isfit05, UKA07, isfit07, UKA09}}\\ % TODO Sjekk om dette blir fint.
